...
<head>
    ...
    <title>Grade 12 Sections</title>
    <link rel="stylesheet" href="../Admin-CSS/grade12_sections.css">
...
<body>
            ...
            <ul>
                ...
                <li class="menu-item active">
                    ...
                    <ul class="submenu show">
                        ...
                        <li>
                            <a href="grade12_sections.php" class="active">
                                <i class="fas fa-layer-group"></i>
                                <span>Grade 12</span>
                            </a>
                        </li>
        ...
        <div class="container-fluid">
            <div class="sections-management">
                ...
                <div class="header-content">
                    <h2>Grade 12 Schedule</h2>
                    <p class="subtitle">Manage Grade 12 sections and schedules</p>
                </div>
                
                <!-- Filter Section with Legend -->
    ...
    <!-- Scripts -->
    <script src="../Admin-JS/grade12_sections.js"></script>
</body>
</html>
